...
def _compact_slow_frame(snapshot: object) -> Optional[Dict[str, object]]:
    ...
    if isinstance(metrics, dict):
        for key in (
            ...
            "fog_geometry_change_mask",
            "fog_geometry_change_detail",
            "fog_rebuild_camera_dx",
            "fog_rebuild_camera_dy",
            "fog_rebuild_zoom_delta",
            "fog_full_build_input_tiles",
            "fog_full_build_visible_no_fog_tiles",
            "fog_full_build_polygon_draw_tiles",
            "fog_full_build_tile_loop_time_ns",
            "fog_full_build_tile_loop_time_ms",
            "fog_full_build_polygon_time_ns",
            "fog_full_build_polygon_time_ms",
