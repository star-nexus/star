#!/usr/bin/env python3
"""Run the same-phase canonical Fog raster feasibility experiment."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Check pixel-exact reuse between matching Fog raster phases"
    )
...
def main() -> int:
    ...
    stopped = output["stop"]
    feasibility = stopped.get("phase_raster_feasibility") or {}
    checks = {
        ...
        "camera_frames_compared": (
            feasibility.get("total_canonical_camera_frames")
    ...
    output["experiment"] = "fog_same_phase_raster_feasibility_v1"
