...
from typing import Dict, List, Set, Type, Optional, Callable, Any, TypeVar, Union, Iterator, Tuple, override
import logging
...
from framework_v2.ecs.query import QueryManager, QueryBuilder, Query
from framework_v2.ecs.manager import EntityManager, ComponentManager, SystemManager
from framework_v2.engine.events import EventManager
from framework_v2.engine.inputs import InputManager
from framework_v2.engine.renders import RenderManager
from framework_v2.engine.scenes import SceneManager
...
class ECSContext:
    ...
    def init_ecs_managers(self, entity_manager, component_manager, system_manager, query_manager):
        """
        初始化基础管理器
    ...
    def init_engine_managers(self, event_manager, input_manager, render_manager, scene_manager):
        """
        初始化引擎管理器
    ...
    def entity_exists(self, entity: Entity) -> bool:
        """检查实体是否存在"""
        return self.entity_manager.is_entity_exists(entity) if self.entity_manager else False
