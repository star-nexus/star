        ...
        for event in pygame.event.get():
            ...
            match event.type:
                ...
                case pygame.MOUSEWHEEL:
                    ...
                    self._pulisher(e)
                    self.logger.info(f"鼠标滚轮: {e}")
                case _:
                    self.logger.info(f"其他事件: {event}")
