...
class EventManager:
    ...
    def subscribe(self, event_type: EventType | List[EventType], handler: Callable[[EventMessage], None], priority: int = 0) -> bool:
        """
    ...
    def _subscribe_single(self, event_type: EventType, handler: Callable[[EventMessage], None], priority: int = 0) -> bool:
        """
        订阅单个事件类型（内部方法）
    ...
    def unsubscribe(self, event_type: EventType | List[EventType], handler: Callable[[EventMessage], None]) -> bool:
        """
    ...
    def _unsubscribe_single(self, event_type: EventType, handler: Callable[[EventMessage], None]) -> bool:
        """
        取消订阅单个事件类型（内部方法）
