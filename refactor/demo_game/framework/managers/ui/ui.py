...
class UIManager:
    ...
    def create_button(self, position: Tuple[int, int], size: Tuple[int, int], 
                      text: str, font: pygame.font.Font, on_click: Callable = None) -> Button:
        """创建按钮
    ...
    def create_panel(self, position: Tuple[int, int], size: Tuple[int, int],
                     color: Tuple[int, int, int] = (80, 80, 80)) -> Panel:
        """创建面板
    ...
    def create_label(self, position: Tuple[int, int], size: Tuple[int, int],
                     text: str, font: pygame.font.Font) -> Label:
        """创建标签
