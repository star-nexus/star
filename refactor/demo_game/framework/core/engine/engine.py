...
class Engine:
    ...
    def __init__(self, title: str = "Game", width: int = 800, height: int = 600, fps: int = 60):
        """初始化游戏引擎
    ...
    def _update(self) -> None:
        """更新游戏逻辑"""
        # 检查场景管理器是否正在进行场景切换
        is_scene_transitioning = self.scene_manager._is_transitioning and self.scene_manager._is_delaying
